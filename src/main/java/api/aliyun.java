...
public class aliyun {
    private static Logger logger = LoggerFactory.getLogger(aliyun.class);
    ...
    aliyun(String accessKeyId, String accessKeySecret, String bucketname, String fileUrl, String endpoint) {
                ...
                try {
                    ...
                    if (id != null) {
                        if (putObjectResult != null) {
                            ...
                            studentCustom = new Student();
                            studentCustom.setHeadPortrait(fileName);
                            studentCustom.setId(id);
                            // 写入数据库
                            if (serviceDao.updataUser(studentCustom)) {
